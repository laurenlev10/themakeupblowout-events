...
def main():
    ...
    if n_form + n_venue + n_ig > 0:
        ...
        print(f"\n✓ Updated {n_form} form_ids, {n_venue} venues, {n_ig} ig_urls")
    else:
        print("\n  no changes needed")
