...
<body>
  <div style="position:fixed;top:10px;right:12px;z-index:1000;display:flex;gap:6px;background:rgba(0,0,0,0.6);padding:6px 10px;border-radius:999px;backdrop-filter:blur(4px);">
    <a href="https://events.themakeupblowout.com/" style="color:#f5e45b;text-decoration:none;font-size:13px;font-weight:700;letter-spacing:0.3px;">📅 All Events</a><span style="color:rgba(255,255,255,0.3);">|</span><a href="index.html" style="color:#fff;text-decoration:none;font-size:13px;font-weight:700;">EN</a>
  ...
  <section class="sms-section" style="background:#000;">
    <div style="max-width: 540px; margin: 0 auto; text-align: center;">
      ...
      <p style="font-size: clamp(17px, 3.5vw, 22px); color: #fff; margin-bottom: 6px;">
        Your FREE glitter voucher is on the way! &#x1F484;&#x2728;
      </p>
      <p style="font-size: clamp(15px, 3vw, 18px); color: #ffcfd2; margin-bottom: 26px;">
        Share with your bestie &amp; get a <strong>FREE Eyeshadow</strong> too!
      </p>

      <a href="{{IG_URL}}" target="_blank" rel="noopener noreferrer" style="display:block;max-width:420px;margin:10px auto;padding:16px 28px;background:linear-gradient(45deg,#f09433 0%,#e6683c 25%,#dc2743 50%,#cc2366 75%,#bc1888 100%);color:#fff;text-decoration:none;font-weight:700;font-size:17px;border-radius:8px;box-shadow:0 8px 24px rgba(220,39,67,0.4);">
        &#x1F4F7; Share on Instagram
      </a>
      <a href="{{FB_URL}}" target="_blank" rel="noopener noreferrer" style="display:block;max-width:420px;margin:10px auto;padding:16px 28px;background:#1877F2;color:#fff;text-decoration:none;font-weight:700;font-size:17px;border-radius:8px;box-shadow:0 8px 24px rgba(24,119,242,0.4);">
        &#x1F44D; Share on Facebook
      </a>
      <a href="{{TIKTOK_URL}}" target="_blank" rel="noopener noreferrer" style="display:block;max-width:420px;margin:10px auto;padding:16px 28px;background:#000;color:#fff;text-decoration:none;font-weight:700;font-size:17px;border-radius:8px;box-shadow:0 8px 24px rgba(255,255,255,0.15);border:2px solid #25F4EE;">
        &#x1F3B5; Share on <span style="color:#25F4EE">Tik</span><span style="color:#FE2C55">Tok</span>
      </a>

      <p style="margin-top: 30px; font-size: 13px; color: #888; line-height: 1.5;">
        Already on our SMS list from your TikTok signup &#x2713; <br>
        See you {{MONTH}} {{START_DAY}} - {{END_DAY}} at {{HOTEL}}!
      </p>

      <div class="gift-media" style="margin-top: 32px;">
        <img src="/_assets/shared/NEW%20GIF.gif" alt="Free Glitter Gift" style="max-width: 250px;">
      </div>
    </div>
  </section>
  ...
  <section class="promo-collage" style="background:#fdf2f8;padding:24px 16px;text-align:center;">
    ...
    <p style="margin:14px 0 0;color:#1f2937;font-weight:700;font-size:14px;letter-spacing:0.5px;text-transform:uppercase;">UP TO 75% OFF &mdash; YOU DON&#39;T WANT TO MISS THIS!</p>
  </section>
